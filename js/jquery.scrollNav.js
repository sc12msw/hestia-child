  ...
  var S = {
    ...
    _setup_sections: function(sections) {
      ...
      $(sections).each(function(i) {
        ...
        /************ MATTS NOTES
         Not needed as I have already set up the sections with the acf. This line wraps the h2 elements with a section but not correctly with acf
    ...
    _check_pos: function() {
      ...
      var boundry_top         = win_top + S.settings.scrollOffset + 100;
